    ...
    public class Prefab_ConnectWallet : MonoBehaviour
    {
        ...
        public async void Disconnect()
        {
            ...
            try
            {
                ...
                StartScreen.GetComponent<StartScreenScript>().setDisconnectedState(ConnectedState, DisconnectedState);
            }
        ...
        private async void PostConnect(WalletConnection wc = null)
        {
            ...
            StartScreen.GetComponent<StartScreenScript>().setConnectedState(ConnectedState, DisconnectedState);
